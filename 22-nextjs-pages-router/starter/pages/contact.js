...
export default function Contact() {
  ...
  return (
    <div>
      ...
      {success === true ? (<p className="text-center text-lg">{message}</p>
      ) : (
        <form className="bg-primary-900 py-10 px-14 text-lg space-y-6 max-w-5xl mx-auto" onSubmit={handleSubmit}>
